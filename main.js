...
const stringsToNumbs = (numbers) => {
    return numbers.map((str) => Number.parseInt(str, 10));

}

const numArr = stringsToNumbs(strNums);

console.log('Here is an array of numbers:', numArr);
...
console.log('The sum of even numbers:', sumEvens(numArr));
